...
df_0 = pd.read_csv('C:/Users/www/Desktop/BackTest/M6/600410/CumuIndicator by second 600410.csv')
...
def sharpe(N, K):
    ...
    #ReturnRate.to_csv('C:/Users/www/Desktop/BackTest/M6/601108/ReturnRate 3300&5.5.csv')    #参数
    #merged_data.to_csv('C:/Users/www/Desktop/BackTest/M6/601108/Daily Return 3300&5.5.csv') #参数

    ReturnDF = {'Sharpe': [SharpeRatio], 'EMA': [N], 'STD': [K], '# of Trade': [Transaction_order]}
    ReturnDF = pd.DataFrame(ReturnDF)

    print(SharpeRatio, N, K, Transaction_order)
    return(ReturnDF)

SharpeRecord = pd.DataFrame(columns=['Sharpe', 'EMA', 'STD', '# of Trade'])
for N in range(1000, 4050, 50):    #upperband is not inclusive
    for K in np.arange(2.5, 6.0, 0.5):
        dfx = sharpe(N, K)
        SharpeRecord = SharpeRecord.append(dfx, ignore_index=True)
SharpeRecord.to_csv("C:/Users/www/Desktop/BackTest/M6/600410/Sharpe Record 600410.csv")

#print(sharpe(3300, 5.5)) #参数
