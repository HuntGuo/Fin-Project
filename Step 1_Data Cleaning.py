...
df = pd.read_csv("C:/Users/www/Desktop/BackTest/M6/601336/601336 20190731.csv", index_col=0)  #7/10/2019 9:00:43 AM
...
print(df)
print('Successfully filter data within trading time')
...
print(df)
print('Successfully calculate CumuIndicator')
...
print(df_integrated)
print('Successfully fill in seconds')

#地址手动修改一下：
df_integrated.to_csv("C:/Users/www/Desktop/BackTest/M6/601336/CumuIndicator by second 601336.csv")
